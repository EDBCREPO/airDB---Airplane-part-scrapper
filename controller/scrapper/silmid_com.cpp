#define PAYLOAD "curl https://www.silmid.com/us/search-results/?searchterm=${0}&searchterm_submit=Go --connect-timeout 5 -Ls"
#pragma once
...
namespace controller { namespace scrapper {
    ...
    promise_t<object_t,except_t> silmid_com_search( string_t search ) {
